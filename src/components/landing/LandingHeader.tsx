        ...
        <header className="absolute top-0 left-0 right-0 z-20 py-4 px-4 sm:px-6 lg:px-8 bg-transparent text-[var(--foreground)]">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <a href={`${appUrl}/register`} className="bg-[var(--primary)] hover:opacity-90 text-white font-bold py-2 px-5 rounded-lg transition text-sm">
                        Comenzar Gratis
                    </a>
                </div>
                ...
                <div className="md:hidden flex items-center">
                    <ThemeToggle />
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="ml-2 p-2 text-[var(--foreground-muted)] hover:text-[var(--foreground)]">
